...
from FunctionsIFInhCurrent_EOnly import *
...
#      print JmatrixNP[:,i]
      ...
      for i in range (1,21):
        ...
        while timeElapsed <T:
            ...
            if (binIndex == binSize):
                ...
                binInhWChange += binDataCount[1]*0
  ...
  aggregateData.append(["E_ONLY/Inh_MeanW",networkMeanWInh3D])
  aggregateData.append(["E_ONLY/Exc_MeanW",networkMeanWExc3D])
  aggregateData.append(["E_ONLY/Inh_WSD",networkMeanWInh3DSD])
  aggregateData.append(["E_ONLY/Exc_WSD",networkMeanWExc3DSD])
