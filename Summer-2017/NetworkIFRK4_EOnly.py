...
from FunctionsIFCorrect_EOnly import *
...
#      print JmatrixNP[:,i]
      ...
      for i in range (1,21):
        ...
        while timeElapsed <T:
            ...
            if (binIndex == binSize):
                ...
                binInhThresholdChange += binDataCount[1]*0
  ...
  #3D
  aggregateData.append(["E_ONLY/Phi",phiValue])
  aggregateData.append(["E_ONLY/Lambda",lambdaValueList])
  aggregateData.append(["E_ONLY/EI_Ratios_Mean",EIRatio3D])
  aggregateData.append(["E_ONLY/EI_Ratios_SD",EIRatio3DSD])
  aggregateData.append(["E_ONLY/Exc_EM_activity",MeanExcActivity3D])
  aggregateData.append(["E_ONLY/Inh_EM_activity",MeanInhActivity3D])
  aggregateData.append(["E_ONLY/Exc_EM_SD",MeanExcActivity3DSD])
  aggregateData.append(["E_ONLY/Inh_EM_SD",MeanInhActivity3DSD])
  aggregateData.append(["E_ONLY/Inh_MeanThreshold",networkMeanThresholdInh3D])
  aggregateData.append(["E_ONLY/Exc_MeanThreshold",networkMeanThresholdExc3D])
  aggregateData.append(["E_ONLY/Inh_ThresholdSD",networkMeanThresholdInh3DSD])
  aggregateData.append(["E_ONLY/Exc_ThresholdSD",networkMeanThresholdExc3DSD])
